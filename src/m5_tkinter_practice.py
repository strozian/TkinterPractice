...
def main():
    ...
    integer_button = ttk.Button(frame1, text='Multiplication')
    integer_button.grid()
    integer_button['command'] = lambda:multiply_integers(my_entry_box, my_other_entry_box)
    # ------------------------------------------------------------------
    # TODO: 8. As time permits, do other interesting GUI things!
    # ------------------------------------------------------------------
    root.mainloop()

def multiply_integers(first_entry, second_entry):
    contents1 = first_entry.get()
    contents2 = second_entry.get()
    print(contents1*int(contents2))
